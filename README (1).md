...
* [Configuration & Profiles](<README (1).md#configuration--profiles>)
  * [Configuration Loading Hierarchy](<README (1).md#configuration-loading-hierarchy>)
  * [Global Configuration (`~/.amnesiac/config.json`)](<README (1).md#global-configuration-amnesiacconfigjson>)
  * [Local Project Configuration (`amnesiac.config.js`)](<README (1).md#local-project-configuration-amnesiacconfigjs>)
* [Commands](<README (1).md#commands>)
  * [`amnesiac`](<README (1).md#amnesiac>)
  * [`amnesiac init`](<README (1).md#amnesiac-init>)
  * [`amnesiac config`](<README (1).md#amnesiac-config>)
  * [`amnesiac use <profile_name>`](<README (1).md#amnesiac-use-profile_name>)
  * [`amnesiac status`](<README (1).md#amnesiac-status>)
  * [`amnesiac reset`](<README (1).md#amnesiac-reset>)
  * [`amnesiac --version`](<README (1).md#amnesiac---version>)
* [API Key and Model Information](<README (1).md#api-key-and-model-information>)
  * [Getting Your API Key](<README (1).md#getting-your-api-key>)
  * [Keeping Your API Key Secure](<README (1).md#keeping-your-api-key-secure>)
  * [Understanding Gemini Models](<README (1).md#understanding-gemini-models>)
* [Changelog](<README (1).md#changelog>)
...
2.  **Configure your API Key and Model:** Run `amnesiac config` to set up your global default profile or create a new one. You'll be prompted for your Gemini API key and preferred model.
    ...
    _(See_ [_Configuration & Profiles_](<README (1).md#configuration--profiles>) _for more details on managing profiles.)_
...
The main command to generate a changelog entry. It uses the configuration determined by the [loading hierarchy](<README (1).md#configuration-loading-hierarchy>).
